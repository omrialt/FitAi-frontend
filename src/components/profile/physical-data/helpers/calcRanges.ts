...
export function calculateBMIRanges(): BMIRanges {
  return {
    ranges: [
      ...
      { label: 'Normal', min: 18.5, max: 24.9, color: 'var(--color-success)' }, // green
      { label: 'Overweight', min: 25, max: 29.9, color: 'var(--color-warning)' }, // yellow
...
export function calculateBodyFatRanges(gender: string, age: number): BodyFatRanges {
  ...
  if (isMale) {
    ...
    if (age >= 20 && age <= 39) {
      return {
        ranges: [
          { label: 'Essential Fat', min: 0, max: 5, color: 'var(--color-danger)' }, // red - too low is dangerous
          { label: 'Athletes', min: 6, max: 13, color: 'var(--color-success)' }, // green - healthy/athletic
          { label: 'Fitness', min: 14, max: 17, color: 'var(--color-success)' }, // darker green - healthy
          { label: 'Average', min: 18, max: 24, color: 'var(--color-warning)' }, // yellow - acceptable
      ...
      return {
        ranges: [
          { label: 'Essential Fat', min: 0, max: 5, color: 'var(--color-danger)' },
          { label: 'Athletes', min: 6, max: 13, color: 'var(--color-success)' },
          { label: 'Fitness', min: 14, max: 17, color: 'var(--color-success)' },
          { label: 'Average', min: 18, max: 26, color: 'var(--color-warning)' },
    ...
    if (age >= 20 && age <= 39) {
      return {
        ranges: [
          { label: 'Essential Fat', min: 0, max: 13, color: 'var(--color-danger)' },
          { label: 'Athletes', min: 14, max: 20, color: 'var(--color-success)' },
          { label: 'Fitness', min: 21, max: 24, color: 'var(--color-success)' },
          { label: 'Average', min: 25, max: 31, color: 'var(--color-warning)' },
      ...
      return {
        ranges: [
          ...
          { label: 'Athletes', min: 14, max: 20, color: 'var(--color-success)' },
          { label: 'Fitness', min: 21, max: 24, color: 'var(--color-success)' },
          { label: 'Average', min: 25, max: 33, color: 'var(--color-warning)' },
      ...
      return {
        ranges: [
          ...
          { label: 'Athletes', min: 14, max: 20, color: 'var(--color-success)' },
          { label: 'Fitness', min: 21, max: 24, color: 'var(--color-success)' },
          { label: 'Average', min: 25, max: 35, color: 'var(--color-warning)' },
